(function colorPickerNamespace(){
	...
	function createColorPicker(){
		if(cp) return;
		cp = $DOM(
			['DIV', {style:'position:absolute; top:25px; z-index:99;font-family:tahoma,verdana,sans-serif;font-size:10px;', ref:'ColorPicker'},
				...
				['DIV', {style:'border:1px solid #000;width:397px;height:305px;position:relative;background-color:#E0DFE3;', ref:'fColorPicker'},
					['DIV', {style:'position:absolute;top:3px;left:8px;'}, 'Seleccione Color:'],
					...
					['DIV', {style:'z-index:200;position:absolute;top:22px;left:317px;width:58px;height:33px;', ref:'curColorDiv'}],
					...
					['BUTTON', {style:'position:absolute;bottom:50px;left:315px;width:77px;', ref:'OK', onclick:hColorPickerMouseDown}, 'Aceptar'],
					['BUTTON', {style:'position:absolute;bottom:25px;left:315px;width:77px;', ref:'Cancel', onclick:hideColorPicker}, 'Cancelar'],
					['INPUT', {type:'checkbox', style:'position:absolute;top:280px;left:4px;', ref:'websafeCheckbox'}],
					['DIV', {style:'position:absolute;top:284px;left:25px;'}, 'Solo Colores para Web'],
	...
	function hColorPickerMouseDown(){
		...
		var color2 = parseColor(cp.cpColor);
		var inverse ='#'+hex((255 - color2.r))+hex((255 - color2.g))+hex (255 - color2.b);
		cp.cpInput.style.color = inverse;		
