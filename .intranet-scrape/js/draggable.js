...
function resizeStart(event, id) {
  ...
  dragObj.elStartLeft  = parseInt(dragObj.elNode.style.left, 10);
  dragObj.elStartTop   = parseInt(dragObj.elNode.style.top,  10);
  // save start width an height
  dragObj.elStartWidth  = parseInt(dragObj.elNode.offsetWidth, 10) - 2;
  dragObj.elStartHeight   = parseInt(dragObj.elNode.offsetHeight,  10) - 36;
...
function resizeXStart(event, id) {
  ...
  if (browser.isIE) {
    document.attachEvent("onmousemove", resizeXGo);
    document.attachEvent("onmouseup",   resizeStop);
    window.event.cancelBubble = true;
    window.event.returnValue = false;
  }
  if (browser.isNS) {
    document.addEventListener("mousemove", resizeXGo,   true);
    document.addEventListener("mouseup",   resizeXStop, true);
    event.preventDefault();
  }
}


function resizeXGo(event) {
...
function resizeXStop(event) {

  // Stop capturing mousemove and mouseup events.

  if (browser.isIE) {
    document.detachEvent("onmousemove", resizeXGo);
    document.detachEvent("onmouseup",   resizeXStop);
  }
  if (browser.isNS) {
    document.removeEventListener("mousemove", resizeXGo,   true);
    document.removeEventListener("mouseup",   resizeXStop, true);
  }
}
