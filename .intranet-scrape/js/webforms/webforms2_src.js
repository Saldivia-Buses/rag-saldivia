...
$wf2 = {
	...
	//	if($wf2.isInitialized)   Comentado por LMM para que al llamar via ajax se re-active
	//		return;
		...
		//Include stylesheet
		/* ANULADA LA CREACION DE CSS EN CADA LLAMADA 
...
//				this.repetitionTemplate.onmoved = new Function('event', onmovedAttr);
	...
	formCheckValidity : function(formName){
		var i, el, valid = true;
		...
		for(i = 0; el = formElements[i]; i++){
                        ...
                        // Do NOT check for inner forms
                        if (el.getAttribute('innerForm') != undefined){
                            if (el.getAttribute('innerForm') != el.getAttribute('form')){
                                continue;
                            }
                        }
...
//	zeroPointTime          : null,
	...
	invalidMessages : {
		valueMissing   : 'Debe ingresar o seleccionar algun valor.',
		typeMismatch   : 'El valor es invalido para el tipo  %s .',
		rangeUnderflow : 'El valor debe ser igual o mayor que %s.',
		rangeOverflow  : 'El valor debe ser igual o menor que %s.',
