          ...
          <SidebarMenu>
            {section.items.map((item) => {
              ...
              return (
                ...
                >
                  <SidebarMenuButton isActive={itemKey === activeItemKey} className="px-2" render={<a href={item.href} onClick={(e) => {
                                              e.preventDefault();
          ...
          {utilities.map((item) => {
            ...
            return (
              <SidebarMenuItem key={item.label}>
                <SidebarMenuButton className="gap-2.5 px-2 text-muted-foreground hover:text-foreground" render={<a href={item.href} />}><Icon className="size-4" /><span>{item.label}</span></SidebarMenuButton>
              </SidebarMenuItem>
            );
          })}
        </SidebarMenu>
      ...
      >
        <SidebarHeader className="h-14 border-b">
          <SidebarMenu className="my-auto">
            <SidebarMenuItem>
              <SidebarMenuButton size="lg" className="md:h-8 md:p-0" render={<a href="#" />}><div className="flex aspect-square size-8 items-center justify-center rounded-sm bg-primary">
                                              <img
                  ...
                  return (
                    <SidebarMenuItem key={item.label}>
                      <SidebarMenuButton tooltip={{
                                                    children: item.label,
                                                    hidden: isMobile,
                                                  }} className="px-2.5 md:px-2" aria-label={item.label} render={<a href={item.href} />}><Icon className="size-4" /><span>{item.label}</span></SidebarMenuButton>
                    </SidebarMenuItem>
                  );
                })}
              </SidebarMenu>{" "}
            ...
            <SidebarMenuItem>
              <DropdownMenu>
                <div className="flex w-full items-center px-2 group-data-[collapsible=icon]:justify-center">
                  <DropdownMenuTrigger render={<Button variant="ghost" className="flex h-auto items-center gap-1.5 p-0! hover:bg-transparent" />}><span className="font-semibold">Shadcnblocks</span><ChevronDown className="size-3 text-muted-foreground" /></DropdownMenuTrigger>
                </div>
                <DropdownMenuContent
  ...
  return (
    <SidebarMenu className={cn("w-full", className)}>
      <SidebarMenuItem className="w-full">
        <DropdownMenu>
          <DropdownMenuTrigger render={<SidebarMenuButton size="default" className="h-10 w-full data-[state=open]:bg-sidebar-accent data-[state=open]:text-sidebar-accent-foreground" />}><Avatar className="h-7 w-7">
