    ...
    return (
      ...
      >
        ...
        >
          ...
          <SliderPrimitive.Thumb render={<motion.span animate={{
                              ...
                              )} transition={{ type: "spring", stiffness: 400, damping: 20 }} whileHover={{ scale: 1.25 }} whileTap={{ scale: 1.1 }} />}>{/* Ping ring */}<motion.span
                                animate={{
                                  scale: [1, 2.2],
                                  opacity: [0.4, 0],
                                }}
